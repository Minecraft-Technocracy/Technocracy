...
interface RoutingStrategy<T : NetworkQuery> {
    ...
    /**
     * Prepares a [NetworkQuery] instance that can then be used to cache routing information generated by this strategy
     *
     * @param providerSink the provider of output that shall be routed through the conduit network
     *
     * @return a [NetworkQuery] that stores state about routes used by [providerSink]
     */
     ...
     *
     * @param world the world server that contains the tile entities modelled by the sinks
