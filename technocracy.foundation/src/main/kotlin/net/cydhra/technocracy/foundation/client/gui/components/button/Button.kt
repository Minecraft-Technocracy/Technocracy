...
abstract class Button(val posX: Int, val posY: Int, val width: Int, val height: Int, val text: String, val fontRenderer: FontRenderer, val onClick: (player: EntityPlayer, tileEntity: TileEntity?, button: Int) -> Unit) : TCComponent() {
