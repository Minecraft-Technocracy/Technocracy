...
class TileEntitySalineHeatingAgentInput : TileEntityMultiBlockPart<SalineMultiBlock>(SalineMultiBlock::class,
        ::SalineMultiBlock) {
    ...
    override fun <T> getCapability(capability: Capability<T>, facing: EnumFacing?): T? {
        return if (hasCapability(capability, facing))
            CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY.cast<T>(
                    multiblockController?.controllerTileEntity?.heatingFluidInputComponent?.fluid)
