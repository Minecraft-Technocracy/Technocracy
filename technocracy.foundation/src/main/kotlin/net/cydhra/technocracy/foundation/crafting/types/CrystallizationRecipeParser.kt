...
object CrystallizationRecipeParser : RecipeParser<CrystallizationRecipe> {
     ...
     */
    override fun process(json: JsonObject, context: JsonContext): CrystallizationRecipe {
        ...
        return CrystallizationRecipe(fluid, outputStack, json.get(JSON_KEY_TICK_COST).asInt)
    }
