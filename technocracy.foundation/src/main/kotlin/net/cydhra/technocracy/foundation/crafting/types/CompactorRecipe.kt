...
/**
 * A recipe model type for compactor recipes. One input, one output.
 */
data class CompactorRecipe(val input: Ingredient, val output: ItemStack, override val processingCost: Int) : IMachineRecipe {
