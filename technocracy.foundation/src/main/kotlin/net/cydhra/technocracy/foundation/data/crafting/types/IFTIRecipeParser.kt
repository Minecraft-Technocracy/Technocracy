...
/**
 * General parser for [IFTIRecipe]
 */
object IFTIRecipeParser : RecipeParser<IFTIRecipe> {
    ...
    /**
     * Parse inputs, output and cost and return an [ITIRecipe]
     *
     * @throws IllegalStateException if any of the parameters is missing in the json file
     */
    override fun process(json: JsonObject, context: JsonContext): IFTIRecipe {
        ...
        return IFTIRecipe(inputIngredient, inputFluid, outputStack, json.get(JSON_KEY_TICK_COST).asInt)
    }
