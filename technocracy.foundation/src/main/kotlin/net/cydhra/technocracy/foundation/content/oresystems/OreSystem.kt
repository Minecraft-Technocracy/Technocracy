...
import net.cydhra.technocracy.foundation.content.items.ColoredPrefixedItem
...
import net.cydhra.technocracy.foundation.content.world.OreGenerator
                    ...
                    if (generateOre) {
                        if (oreEnabled) {
                            GameRegistry.registerWorldGenerator(
                                OreGenerator(oreGeneratorSettings.oreDimensions,
