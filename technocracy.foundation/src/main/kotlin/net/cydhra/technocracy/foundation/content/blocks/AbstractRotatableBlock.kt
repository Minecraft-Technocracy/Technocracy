...
import net.cydhra.technocracy.foundation.api.blocks.util.IDynamicBlockStateContainer
import net.cydhra.technocracy.foundation.content.blocks.AbstractRotatableBlock.Companion.facingProperty
...
abstract class AbstractRotatableBlock(unlocalizedName: String,
    ...
    override fun getStateForPlacement(worldIn: World, pos: BlockPos, facing: EnumFacing, hitX: Float, hitY: Float, hitZ: Float, meta: Int, placer: EntityLivingBase): IBlockState {
        return addPropertyToState(defaultState.withProperty(
            AbstractRotatableTileEntityBlock.facingProperty, placer.adjustedHorizontalFacing
