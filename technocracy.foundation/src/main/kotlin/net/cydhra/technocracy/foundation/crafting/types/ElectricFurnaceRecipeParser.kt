 ...
 */
object ElectricFurnaceRecipeParser : RecipeParser<ElectricFurnaceRecipe> {
     ...
     */
    override fun process(json: JsonObject, context: JsonContext): ElectricFurnaceRecipe {
        ...
        return ElectricFurnaceRecipe(inputIngredient, outputStack, json.get(JSON_KEY_TICK_COST).asInt)
    }
