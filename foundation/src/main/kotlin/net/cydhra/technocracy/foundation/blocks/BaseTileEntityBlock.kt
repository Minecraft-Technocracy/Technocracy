...
abstract class BaseTileEntityBlock : BaseBlock , ITileEntityProvider {

    companion object {
        val FACING = BlockHorizontal.FACING;
    }

    constructor(unlocalizedName: String, registryName: String, colorMultiplier: ConstantBlockColor?, material: Material) : super(unlocalizedName, registryName, colorMultiplier, material)
